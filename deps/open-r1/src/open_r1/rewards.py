...
def get_reward_funcs(script_args) -> list[Callable]:
    REWARD_FUNCS_REGISTRY = {
        ...
        # Unified multi-domain reward functions
        "unified_format_reward": unified_format_reward,
        "unified_code_execution_reward": unified_code_execution_reward,
        "unified_code_execution_reward_no_oracle": unified_code_execution_reward_no_oracle,  # ABLATION: No oracle anchoring
        "unified_generalization_reward": unified_generalization_reward,
        "unified_nominal_reward": unified_nominal_reward,  # ABLATION: No generalization testing
        "unified_soft_nominal_reward": unified_soft_nominal_reward,
        "unified_nominal_reward_topk_interaction_bound": unified_nominal_reward_topk_interaction_bound,
